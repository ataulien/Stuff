...
namespace LevelMesh
{
    namespace Internal
    {
        ...
        using StaticLevelMesh = Mesh::StaticMeshDynSize<V,
                I,
        ...
        using StaticLevelMeshFixed = Mesh::StaticMeshFixedSize<V,
                I,
                Materials::Material::HandleType,
                VHDL,
                IHDL,
     ...
     */
    template<typename V, typename I>
    void fromVertexData(StaticLevelMeshFixed<V, I, 1>& target, const std::vector<V>& vertices,
